...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<?> custumerNotFound(GenericException genEx, WebRequest wq){
		log.info("Exception trapped in globalException Handler#Restaurant-Service  :: {} ", ExceptionUtils.getStackTrace(genEx));
	...
	public ResponseEntity<?> myMANVExceptionHandler(MethodArgumentNotValidException me) {
		log.info("Exception trapped in globalException Handler#Restaurant-Service  :: {} ", ExceptionUtils.getStackTrace(me));
	...
	public ResponseEntity<?> mynotFoundHandler(NoHandlerFoundException nfe,WebRequest wq) {
		log.info("Exception trapped in globalException Handler#Restaurant-Service  :: {} ", ExceptionUtils.getStackTrace(nfe));
	...
	public ResponseEntity<?> myExceptionHandler(Exception e, WebRequest wq) throws IOException {
		log.info("Exception trapped in globalException Handler#Restaurant-Service  :: {} ", ExceptionUtils.getStackTrace(e));
